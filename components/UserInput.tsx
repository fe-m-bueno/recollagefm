  ...
  return (
    <form onSubmit={handleSubmit} className="p-6 ~w-[20rem]/[44rem]">
      <div className="flex flex-wrap gap-4 mb-4">
        <div className="flex-1 w-full  ~text-[0.7rem]/md">
          ...
          <input
            ...
            required
            className="dark:bg-black/25 bg-white/80 backdrop-blur-sm focus:outline-none placeholder:text-slate-500 dark:placeholder:text-slate-300 placeholder:~text-sm /[1rem] focus:ring-2 focus:ring-blue-600 dark:focus:ring-white/50 border dark:border-white/10 w-full px-3 ~py-1/2 rounded"
          />
        </div>
      ...
      <div className="flex flex-row items-center justify-center ~text-sm/base">
        <button
          type="submit"
          className={`~w-[10rem]/[12rem] transition bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))]  from-blue-600/95 to-blue-600 dark:hover:bg-white/10 dark:bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))]  backdrop-blur-sm dark:from-white/10 dark:to-white/5 text-white py-4 px-4 rounded-full mt-10 border dark:border-white/50 border-blue-700 hover:bg-blue-700 font-bold shadow-md`}
          disabled={loading}
