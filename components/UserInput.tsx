      ...
      <div className="flex flex-wrap gap-4 mb-4">
        <div className="flex-1 min-w-[7rem] ~text-[0.7rem]/md">
          ...
          <input
            ...
            required
            className="dark:bg-black/25 bg-white/80 backdrop-blur-sm focus:outline-none placeholder:text-slate-500 dark:placeholder:text-slate-300 placeholder:~text-[0.5rem]/[1rem] focus:ring-2 focus:ring-blue-600 dark:focus:ring-white/50 border dark:border-white/10 w-full px-3 ~py-1/2 rounded"
          />
        </div>
